...
- (void)drawRect:(CGRect)rect {
    ...
    float windowWidth =  [ UIScreen mainScreen ].applicationFrame.size.width;
    float windowHeight =  [ UIScreen mainScreen ].applicationFrame.size.height;
    
	CGRect boxRect = CGRectMake(0,64,windowWidth,windowHeight);
	float radius = 0.0f;
