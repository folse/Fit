...
- (void)buildScrollView {
    ...
    UITapGestureRecognizer *imageTap = [[UITapGestureRecognizer alloc] initWithTarget:self.delegate action:@selector(openProgram:)];
    [self addGestureRecognizer:imageTap];
    
}

-(void)openProgram:(UITapGestureRecognizer*)recognizer
{
    NSLog(@"1");
}
